                                        ...
                                        <div class="col-sm-6 col-xs-12">
                                            <div class="call-to-action">
                                                <ul class="list-inline">
                                                    <li><a href="#"><i class="fa fa-phone"></i> 030-57794047</a></li>
                        ...
                        <nav class="navbar navbar-default" role="navigation">
                            <div class="container mainnav">
                                ...
                                <div class="collapse navbar-collapse navbar-collapse">
                                    ...
                                    <span class="search-button pull-right" style="display:none"><a href="#search"><i class="fa fa-search"></i></a></span>
                                    ...
                                    <ul class="nav navbar-nav navbar-right">
                                        ...
                                        <!-- Services -->
                                        <li class="dropdown <?php if ($controller == 'services') echo ' active '; ?>"><a href="javascript:;"><?php echo lang("menu_services"); ?> <span class="fa fa-angle-down"></span></a>
                                            <!-- submenu-wrapper -->
