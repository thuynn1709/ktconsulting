...
<html lang="en">
    ...
    <body>
        <div class="container text-center">
            <div class="logo-404">
                <a href="#"><img src="<?php echo base_url(); ?>public/frontend/images/home/logo.png" alt="" /></a>
            </div>
            <div class="content-404">
                <img src="<?php echo base_url(); ?>public/frontend/images/404/404.png" class="img-responsive" alt="" />
                <h1><b><?php echo lang('error_sorry') ?></b> <?php echo lang('error_notfound') ?></h1>
                <p><?php echo lang('error_detail') ?></p>
                <h2><a href="<?php echo base_url('home'); ?>"><?php echo lang('error_back_homepage') ?></a></h2>
            </div>
        </div>
