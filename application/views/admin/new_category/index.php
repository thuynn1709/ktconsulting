              ...
              <table class="table table-hover">
                ...
                <?php 
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="btn-group">
                            <button type="button" ref="<?php echo base_url('admin/new_category/edit/'). $rs->id ; ?>" class="btn btn-info">Sửa</button>
                            <button type="button" ref="<?php echo base_url('admin/new_category/delete/'). $rs->id ; ?>" class="btn btn-warning">Xóa</button>
                        </div>  
...
<script type="text/javascript">
    $( document ).ready(function() {
        ...
        $('#add_new').click(function() {
            window.location.href = '<?php echo base_url(); ?>admin/new_category/add';
            return false;
        });
