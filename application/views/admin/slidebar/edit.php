                                            ...
                                            <div class="panel-body">
                                                <div class="tab-content">
                                                    <div class="tab-pane fade in active" id="tab1default">
                                                        <input type="text" name="title_vn" class="form-control" value="<?php echo $item->title_vn; ?> " id="exampleInputEmail1" placeholder="Nhập tên đề tiếng việt">
                                                    </div>
                                                    <div class="tab-pane fade" id="tab2default">
                                                        <input type="text" name="title_en" class="form-control" value="<?php echo $item->title_en; ?> " id="exampleInputEmail1" placeholder="Nhập tên đề tiếng anh">
                                                    </div>
                                                    <div class="tab-pane fade" id="tab3default">
                                                        <input type="text" name="title_de" class="form-control" value="<?php echo $item->title_de; ?> " id="exampleInputEmail1" placeholder="Nhập tên đề tiếng đức">
                                                    </div>
