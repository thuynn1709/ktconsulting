                                                    ...
                                                    <div class="tab-pane fade in active" id="tabcontent1">
                                                        <div class="box">
                                                            ...
                                                            <div class="box-body pad">
                                                                ...
                                                                <textarea class="textarea" name="content_vn" placeholder="Nội dung tin tức"
                                                                          style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                                                    ...
                                                    <div class="tab-pane fade" id="tabcontent2">
                                                        <div class="box">
                                                            ...
                                                            <div class="box-body pad">
                                                                ...
                                                                <textarea class="textarea" name="content_en" placeholder="Nội dung tin tức"
                                                                          style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                                                    ...
                                                    <div class="tab-pane fade" id="tabcontent3">
                                                        <div class="box">
                                                            ...
                                                            <div class="box-body pad">
                                                                ...
                                                                <textarea class="textarea" name="content_de" placeholder="Nội dung tin tức"
                                                                          style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
